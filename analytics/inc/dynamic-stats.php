    ...
    class HKB_Dynamic_Stats {
        ...
        */
        function hkba_dynamic_stats() {
            ...
            $begin_sql = date('Y-m-d', $begin_timestamp + $day_offset);
            ...
            switch ($action) {
                case 'updateusermetadates':
                    ...
                    $active_period = (isset($_GET['period']) && $_GET['period']) ? $_GET['period'] : '';
                ...
                case 'feedbackcards':
                    ...
                    $limit = 6;
                    $fetch_limit = $limit+1;
                    $show = (isset($_GET['show']) && $_GET['show']) ? $_GET['show'] : 'all';
                    $magnitude_clause = '';
                    switch ($show) {
                        case 'helpful':
