	...
	class HT_Voting {	
	    ...
	    */
	    public function register_ht_voting_shortcode_scripts_and_styles(){
			...
			$ht_voting_frontend_js_src = (HKB_DEBUG_SCRIPTS) ? 'js/ht-voting-frontend-js.js' : 'js/ht-voting-frontend-js.min.js';
			wp_register_script( 'ht-voting-frontend-script', plugins_url( $ht_voting_frontend_js_src, __FILE__ ), array('jquery') , 1.0, true );	            
