    ...
    class HT_KB_Exits_Dummy_Data_Creator {
        ...
        */
        function  add_test_data(){            
            ...
            //object to add to 
            $object = (isset($_GET['object']) && $_GET['object']) ? $_GET['object'] : '';
        ...
        */
        function enqueue_scripts_and_styles(){
            wp_enqueue_script( 'ht-exits-dummy-data', plugins_url( 'js/ht-exits-dummy-data.js', dirname( __FILE__ ) ), array(), '1.0', true );
        }
